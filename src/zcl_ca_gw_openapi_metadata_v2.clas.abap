CLASS zcl_ca_gw_openapi_metadata_v2 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    INTERFACES zif_ca_gw_openapi_metadata .
...
CLASS zcl_ca_gw_openapi_metadata_v2 IMPLEMENTATION.
...
*   Return metadata handler instance
    ri_metadata ?= NEW zcl_ca_gw_openapi_metadata_v2( iv_external_service = iv_external_service
  ...
  METHOD zif_ca_gw_openapi_metadata~get_json.
...
*   Set exporting parameters
  ...
  METHOD zif_ca_gw_openapi_metadata~get_metadata.
